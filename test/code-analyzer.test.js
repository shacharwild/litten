...
describe('19', () => {
    it('is substituting globals in and out of function correctly ', () => {
        let codeToParse=
            'let z=[1,true,\'sora\'];\n' +
            'function foo(x,i){\n' +
            'let k=z[1];\n' +
...
/*
describe('20', () => {
    it('is substituting a complicated array statements   correctly', () => {
        it('is substituting a complicated array statements   correctly', () => {
            let codeToParse=
            'let z=[1,true,\'sora\'];\n' +
                'function foo(x,i){\n' +
                ...
                'let kaki=5;\n';
            let tablee =parseCode(codeToParse); //make table
            let finalCode=symbolicSubstitutionn(codeToParse, '[1,1,1],2',tablee);
...
describe('21', () => {
    it('is substituting an array length statement correctly', () => {
        it('is substituting an array length statement correctly', () => {
            let codeToParse=
                'function x(arr,y){\n' +
                'let a=arr.length;\n' +
                ...
                '}\n';
            let tablee =parseCode(codeToParse); //make table
            let finalCode=symbolicSubstitutionn(codeToParse, '[1,1,1,1]',tablee);
            let endCode=convertToString(finalCode);
            assert.deepEqual(
                convertToString(endCode),
                'function x(arr,y){\n' +
...
describe('22', () => {
    it('is substituting an array within array code correctly', () => {
        it('is substituting an array within array code correctly', () => {
            let codeToParse=
                'function foo(x,i){\n' +
                'let index=1;\n' +
